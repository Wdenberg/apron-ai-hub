  ...
  return (
    <AppShell>
          ...
          <DialogContent>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="category" name="category" defaultValue={editing?.category ?? ""} maxLength={40} placeholder="Ex.: Marmitas" />
              </div>
      ...
      {isLoading ? (
        ...
        <EmptyState onNew={() => { setEditing(null); setDialogOpen(true); }} />
      ) : (
          ...
          {products.map((p) => (
            <div key={p.id} className="rounded-2xl border border-border bg-card p-5 flex flex-col">
              <div className="flex items-start justify-between gap-3">
                ...
                <button className="text-muted-foreground hover:text-primary" onClick={() => { setEditing(p); setDialogOpen(true); }}>
